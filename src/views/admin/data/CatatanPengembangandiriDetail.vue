...
const getData = async () => {
  try {
    const response = await Api.get(`ortu/data/catatan/pengembangandiri/${id}`);
      ...
      <div class="overflow-x-auto px-4 space-y-10 py-2">
        <div class="space-y-2">
          ...
          <div class="space-y-2 border-b-2 py-2">
            <p class="indent-8 text-gray-700">{{ data.idedanimajinasi }}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg px-4 py-2">
      <div class="overflow-x-auto px-4 space-y-10 py-2">
        <div class="space-y-2">
          ...
          <div class="space-y-2 border-b-2 py-2">
            <p class="indent-8 text-gray-700">{{ data.ketrampilan }}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg px-4 py-2">
      <div class="overflow-x-auto px-4 space-y-10 py-2">
        <div class="space-y-2">
          ...
          <div class="space-y-2 border-b-2 py-2">
            <p class="indent-8 text-gray-700">{{ data.kreatif }}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg px-4 py-2">
      <div class="overflow-x-auto px-4 space-y-10 py-2">
        <div class="space-y-2">
          ...
          <div class="space-y-2 border-b-2 py-2">
            <p class="indent-8 text-gray-700">{{ data.organisasi }}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg px-4 py-2">
      <div class="overflow-x-auto px-4 space-y-10 py-2">
        <div class="space-y-2">
          ...
          <div class="space-y-2 border-b-2 py-2">
            <p class="indent-8 text-gray-700">{{ data.kelanjutanstudi }}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg px-4 py-2">
      <div class="overflow-x-auto px-4 space-y-10 py-2">
        <div class="space-y-2">
          ...
          <div class="space-y-2 border-b-2 py-2">
            <p class="indent-8 text-gray-700">{{ data.citacita }}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg px-4 py-2">
      <div class="overflow-x-auto px-4 space-y-10 py-2">
        <div class="space-y-2">
          ...
          <div class="space-y-2 border-b-2 py-2">
            <p class="indent-8 text-gray-700">{{ data.kemampuankhusus }}</p>
          </div>
        </div>
      </div>
    </div>
